...
Here is the complete syntax of Richard in BNF.
...
<Expr Arit>                   ::= <Mult Exp> '+' <Expression> | <Mult Exp> '-' <Expression> | <Mult Exp>
                        
<Mult Exp>                    ::= <Negate Exp> '*' <Expression> | <Negate Exp> '/' <Expression> | <Negate Exp>
...
<Condition>                   ::= <Negate> <Expression> <Relational Logic> | '(' <Condition> ')' <Relational Logic>
...
<Valid Values>                ::= <Value> | <Valid Identifier> <Attribute Access>
